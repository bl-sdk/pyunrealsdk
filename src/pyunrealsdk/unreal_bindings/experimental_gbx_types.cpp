...
void register_experimental_gbx_types(py::module_& mod) {
    ...
    py::classh<FGameDataHandle>(
        mod, PYUNREALSDK_STUBGEN_CLASS("FGameDataHandle", ),
        ...
        .def_readwrite(PYUNREALSDK_STUBGEN_READONLY_PROP("_name", "str"), &FGameDataHandle::name)
        .def_readwrite(PYUNREALSDK_STUBGEN_READONLY_PROP("_type_handle", "int"),
                       &FGameDataHandle::type_handle)
        .def(PYUNREALSDK_STUBGEN_METHOD_N("__init__", "None")
                 py::init([](uint32_t type_handle, FName name) {
                     return FGameDataHandle{.name = name, .type_handle = type_handle};
                 }),
             PYUNREALSDK_STUBGEN_DOCSTRING(
             ...
             PYUNREALSDK_STUBGEN_ARG("type_handle"_a, "int", ),
             PYUNREALSDK_STUBGEN_ARG("name"_a, "str", ))
        .def(
            PYUNREALSDK_STUBGEN_METHOD("__repr__", "str"),
            [](const FGameDataHandle& self) {
                auto struct_str =
                    self.instance == nullptr ? "None" : struct_repr(self.instance->to_struct());
                return std::format("FGameDataHandle({}, '{}', {})", self.type_handle, self.name,
                                   struct_str);
            },
            PYUNREALSDK_STUBGEN_DOCSTRING("Gets a string representation of this FGameDataHandle.\n"
                                          "\n"
                                          "Returns:\n"
        ...
        .def(
            ...
            [](const py::object& self) {
                auto instance = py::cast<FGameDataHandle*>(self)->instance;
                auto type = instance == nullptr ? nullptr : instance->get_type();
                return py_dir(self, type);
            },
            PYUNREALSDK_STUBGEN_DOCSTRING(
        ...
        .def(
            ...
            [](const FGameDataHandle& self, const FName& name) {
                const UScriptStruct* type = nullptr;
                if (self.instance == nullptr || (type = self.instance->get_type()) == nullptr) {
                    throw py::attribute_error(
                        std::format("unresolved FGameDataHandle has no attribute '{}'", name));
                }
                return py_getattr(py_find_field(name, type),
        ...
        .def(
            ...
            [](const FGameDataHandle& self, PyFieldVariant::from_py_type field) {
                ...
                const UScriptStruct* type = nullptr;
                if (self.instance == nullptr || (type = self.instance->get_type()) == nullptr) {
                    throw py::attribute_error("cannot access field on unresolved FGameDataHandle");
                }
        ...
        .def(
            ...
            [](FGameDataHandle& self, const py::str& name, const py::object& value) {
                ...
                if (self.instance == nullptr || (type = self.instance->get_type()) == nullptr) {
                    throw py::attribute_error(
                        std::format("unresolved FGameDataHandle has no attribute '{}'", fname));
                }
                py_setattr_direct(py_find_field(fname, type),
        ...
        .def(
            ...
            [](FGameDataHandle& self, PyFieldVariant::from_py_type field, const py::object& value) {
                const PyFieldVariant var{field};
                if (var == nullptr) {
                    throw py::attribute_error("cannot access null attribute");
                }
        ...
        .def(
            ...
            [](const FGameDataHandle& self) { return reinterpret_cast<uintptr_t>(self.instance); },
            PYUNREALSDK_STUBGEN_DOCSTRING(
                "Gets the address of this handle's resolved instance, for debugging.\n"
                "\n"
                "Returns:\n"
                "    This instance's address.\n"))
        // We can't have an _experimental_alloc_and_mem_leak() method because we don't know how to
        // go from type handle -> pointer to get its size
        .def(
            PYUNREALSDK_STUBGEN_METHOD("_experimental_free_and_use_after_free", "None"),
            [](FGameDataHandle& self) {
                if (self.instance == nullptr) {
                    throw std::invalid_argument(
                        "Cannot free a FGameDataHandle which has not been resolved!");
                }
                FGbxDef* ptr = nullptr;
    ...
    py::classh<FGbxDefPtr>(
        ...
        PYUNREALSDK_STUBGEN_DOCSTRING("EXPERIMENTAL TYPE.\n"
                                      "\n"
                                      "While the interface is getting more certain, we "
        ...
        .def(
            ...
            [](FGbxDefPtr& self) {
                ...
                self.instance = unrealsdk::u_malloc<FGbxDef>(self.type->get_struct_size());
            },
            PYUNREALSDK_STUBGEN_DOCSTRING(
